...
/* Created on: Tue Aug 30 20:45:24 CEST 2016                  */
/* DBMS      : MySql                                          */
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_attribute VALUES (NEW.ID, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_attributeconstraints VALUES (NEW.ID, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		...
		THEN
			REPLACE INTO ht_t_attributeconstraints VALUES (OLD.ID, NOW());
		END IF;
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_attributetag VALUES (NEW.PropertyID, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_connector VALUES (NEW.Connector_ID, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_diagram VALUES (NEW.Diagram_ID, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_diagramlinks VALUES (NEW.Instance_ID, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_diagramobjects VALUES (NEW.Instance_ID, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_object VALUES (NEW.Object_ID, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_operation VALUES (NEW.OperationID, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_operationparams VALUES (NEW.Name, NOW());
	END $
DELIMITER ;
...
FOR EACH ROW
	BEGIN
		REPLACE INTO ht_t_package VALUES (NEW.Package_ID, NOW());
	END $
DELIMITER ;
