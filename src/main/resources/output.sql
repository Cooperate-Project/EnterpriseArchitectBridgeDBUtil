...
/* Created on: Wed Aug 10 19:24:32 CEST 2016                  */
/* DBMS      : MySql                                          */
...
DELIMITER $
CREATE TRIGGER `ht_t_attributeTrigger` AFTER UPDATE ON `t_attribute`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_attributeconstraintsTrigger` AFTER UPDATE ON `t_attributeconstraints`
FOR EACH ROW
  BEGIN
    IF NEW.Object_ID <> OLD.Object_ID OR
...
DELIMITER $
CREATE TRIGGER `ht_t_attributetagTrigger` AFTER UPDATE ON `t_attributetag`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_connectorTrigger` AFTER UPDATE ON `t_connector`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramTrigger` AFTER UPDATE ON `t_diagram`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramlinksTrigger` AFTER UPDATE ON `t_diagramlinks`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramobjectsTrigger` AFTER UPDATE ON `t_diagramobjects`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_objectTrigger` AFTER UPDATE ON `t_object`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_operationTrigger` AFTER UPDATE ON `t_operation`
FOR EACH ROW
  BEGIN
    IF NEW.Object_ID <> OLD.Object_ID OR
       NEW.Abstract <> OLD.Abstract OR
...
DELIMITER $
CREATE TRIGGER `ht_t_operationparamsTrigger` AFTER UPDATE ON `t_operationparams`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_packageTrigger` AFTER UPDATE ON `t_package`
FOR EACH ROW
  BEGIN
