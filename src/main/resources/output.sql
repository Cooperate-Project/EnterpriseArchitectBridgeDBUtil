...
/* Created on: Tue Nov 29 00:26:10 CET 2016                  */
/* DBMS      : MySql                                          */
...
DROP EVENT IF EXISTS `ht_t_attributeCleanEvent`;
...
DROP EVENT IF EXISTS `ht_t_attributeconstraintsCleanEvent`;
...
DROP EVENT IF EXISTS `ht_t_attributetagCleanEvent`;
...
DROP EVENT IF EXISTS `ht_t_connectorCleanEvent`;
...
DROP EVENT IF EXISTS `ht_t_diagramCleanEvent`;
...
DROP EVENT IF EXISTS `ht_t_diagramlinksCleanEvent`;
...
DROP EVENT IF EXISTS `ht_t_diagramobjectsCleanEvent`;
...
DROP EVENT IF EXISTS `ht_t_objectCleanEvent`;
...
DROP EVENT IF EXISTS `ht_t_operationCleanEvent`;
...
DROP EVENT IF EXISTS `ht_t_packageCleanEvent`;
...
DELIMITER $
CREATE TRIGGER `ht_t_attributeInsertTrigger`
AFTER INSERT ON `t_attribute`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_attributeUpdateTrigger`
AFTER UPDATE ON `t_attribute`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_attributeDeleteTrigger`
AFTER DELETE ON `t_attribute`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_attribute VALUES (OLD.ID, NOW(6));
  END $
...
CREATE EVENT `ht_t_attributeCleanEvent`
...
DELIMITER $
CREATE TRIGGER `ht_t_attributeconstraintsInsertTrigger`
AFTER INSERT ON `t_attributeconstraints`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_attributeconstraintsUpdateTrigger`
AFTER UPDATE ON `t_attributeconstraints`
FOR EACH ROW
  BEGIN
    IF NEW.Object_ID <> OLD.Object_ID OR
...
DELIMITER $
CREATE TRIGGER `ht_t_attributeconstraintsDeleteTrigger`
AFTER DELETE ON `t_attributeconstraints`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_attributeconstraints VALUES (OLD.ID, NOW(6));
  END $
...
CREATE EVENT `ht_t_attributeconstraintsCleanEvent`
  ON SCHEDULE EVERY 1 MINUTE
  ON COMPLETION PRESERVE
ENABLE
DO
...
DELIMITER $
CREATE TRIGGER `ht_t_attributetagInsertTrigger`
AFTER INSERT ON `t_attributetag`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_attributetagUpdateTrigger`
AFTER UPDATE ON `t_attributetag`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_attributetagDeleteTrigger`
AFTER DELETE ON `t_attributetag`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_attributetag VALUES (OLD.PropertyID, NOW(6));
  END $
...
CREATE EVENT `ht_t_attributetagCleanEvent`
  ON SCHEDULE EVERY 1 MINUTE
  ON COMPLETION PRESERVE
ENABLE
DO
...
DELIMITER $
CREATE TRIGGER `ht_t_connectorInsertTrigger`
AFTER INSERT ON `t_connector`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_connectorUpdateTrigger`
AFTER UPDATE ON `t_connector`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_connectorDeleteTrigger`
AFTER DELETE ON `t_connector`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_connector VALUES (OLD.Connector_ID, NOW(6));
  END $
...
CREATE EVENT `ht_t_connectorCleanEvent`
  ON SCHEDULE EVERY 1 MINUTE
  ON COMPLETION PRESERVE
ENABLE
DO
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramInsertTrigger`
AFTER INSERT ON `t_diagram`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramUpdateTrigger`
AFTER UPDATE ON `t_diagram`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramDeleteTrigger`
AFTER DELETE ON `t_diagram`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_diagram VALUES (OLD.Diagram_ID, NOW(6));
  END $
...
CREATE EVENT `ht_t_diagramCleanEvent`
  ON SCHEDULE EVERY 1 MINUTE
  ON COMPLETION PRESERVE
ENABLE
DO
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramlinksInsertTrigger`
AFTER INSERT ON `t_diagramlinks`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramlinksUpdateTrigger`
AFTER UPDATE ON `t_diagramlinks`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramlinksDeleteTrigger`
AFTER DELETE ON `t_diagramlinks`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_diagramlinks VALUES (OLD.Instance_ID, NOW(6));
  END $
...
CREATE EVENT `ht_t_diagramlinksCleanEvent`
  ON SCHEDULE EVERY 1 MINUTE
  ON COMPLETION PRESERVE
ENABLE
DO
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramobjectsInsertTrigger`
AFTER INSERT ON `t_diagramobjects`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramobjectsUpdateTrigger`
AFTER UPDATE ON `t_diagramobjects`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_diagramobjectsDeleteTrigger`
AFTER DELETE ON `t_diagramobjects`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_diagramobjects VALUES (OLD.Instance_ID, NOW(6));
  END $
...
CREATE EVENT `ht_t_diagramobjectsCleanEvent`
  ON SCHEDULE EVERY 1 MINUTE
  ON COMPLETION PRESERVE
ENABLE
DO
...
DELIMITER $
CREATE TRIGGER `ht_t_objectInsertTrigger`
AFTER INSERT ON `t_object`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_objectUpdateTrigger`
AFTER UPDATE ON `t_object`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_objectDeleteTrigger`
AFTER DELETE ON `t_object`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_object VALUES (OLD.Object_ID, NOW(6));
  END $
...
CREATE EVENT `ht_t_objectCleanEvent`
  ON SCHEDULE EVERY 1 MINUTE
  ON COMPLETION PRESERVE
ENABLE
DO
...
DELIMITER $
CREATE TRIGGER `ht_t_operationInsertTrigger`
AFTER INSERT ON `t_operation`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_operationUpdateTrigger`
AFTER UPDATE ON `t_operation`
FOR EACH ROW
  BEGIN
    IF NEW.Object_ID <> OLD.Object_ID OR
       NEW.Abstract <> OLD.Abstract OR
...
DELIMITER $
CREATE TRIGGER `ht_t_operationDeleteTrigger`
AFTER DELETE ON `t_operation`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_operation VALUES (OLD.OperationID, NOW(6));
  END $
...
CREATE EVENT `ht_t_operationCleanEvent`
  ON SCHEDULE EVERY 1 MINUTE
  ON COMPLETION PRESERVE
ENABLE
DO
...
DELIMITER $
CREATE TRIGGER `ht_t_operationparamsInsertTrigger`
AFTER INSERT ON `t_operationparams`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_operationparamsUpdateTrigger`
AFTER UPDATE ON `t_operationparams`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_operationparamsDeleteTrigger`
AFTER DELETE ON `t_operationparams`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_operationparams VALUES (OLD.Name, NOW(6));
  END $
...
DELIMITER $
CREATE TRIGGER `ht_t_packageInsertTrigger`
AFTER INSERT ON `t_package`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_packageUpdateTrigger`
AFTER UPDATE ON `t_package`
FOR EACH ROW
  BEGIN
...
DELIMITER $
CREATE TRIGGER `ht_t_packageDeleteTrigger`
AFTER DELETE ON `t_package`
FOR EACH ROW
  BEGIN
    REPLACE INTO ht_t_package VALUES (OLD.Package_ID, NOW(6));
  END $
...
CREATE EVENT `ht_t_packageCleanEvent`
  ON SCHEDULE EVERY 1 MINUTE
  ON COMPLETION PRESERVE
ENABLE
DO
